...
namespace Ryntra::Compiler {
    ...
    public:
        ...
        virtual Type visitBooleanLiteral(std::shared_ptr<BooleanLiteralNode> node) = 0;
        ...
        virtual Type visitPostfixExpression(std::shared_ptr<PostfixExpressionNode> node) = 0;
